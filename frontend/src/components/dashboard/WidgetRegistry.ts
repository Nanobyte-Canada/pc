...
export const WIDGET_REGISTRY: Record<WidgetKey, WidgetRegistryEntry> = {
  PORTFOLIO_VALUE: { key: 'PORTFOLIO_VALUE', title: 'Portfolio Value', defaultVisible: true, defaultColumnSpan: 2, defaultSortOrder: 0, category: 'CATEGORY_1', component: PortfolioValueWidget },
  ...
  OPEN_ORDERS: { key: 'OPEN_ORDERS', title: 'Open Orders', defaultVisible: true, defaultColumnSpan: 1, defaultSortOrder: 6, category: 'CATEGORY_2', component: OpenOrdersWidget },
  FEES_COMMISSION: { key: 'FEES_COMMISSION', title: 'Fees & Commission', defaultVisible: true, defaultColumnSpan: 1, defaultSortOrder: 7, category: 'CATEGORY_2', component: FeesCommissionWidget },
  DIVIDEND_CALENDAR: { key: 'DIVIDEND_CALENDAR', title: 'Dividend Calendar', defaultVisible: true, defaultColumnSpan: 1, defaultSortOrder: 8, category: 'CATEGORY_2', component: DividendCalendarWidget },
