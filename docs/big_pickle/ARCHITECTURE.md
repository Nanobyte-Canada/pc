...
| strategy | market-data | Configured URL | None | Quote/chain data (not implemented yet) |
| strategy | portfolio | Configured URL | None | Portfolio data (not implemented yet) |
